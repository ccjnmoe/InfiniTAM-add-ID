...
try
{
	const char *calibFile = "D:\\VC Project\\InfiniTAM-master\\InfiniTAM\\Files\\Teddy\\calib.txt";
...
do {
	...
	UIEngine::Instance()->Initialise(argc, argv, imageSource, mainEngine, "InfiniTAM\\Files\\Out");
