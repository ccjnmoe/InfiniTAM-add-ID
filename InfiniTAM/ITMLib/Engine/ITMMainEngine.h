	...
	namespace Engine
	{
		...
		*/
		...
		private:
			...
			ITMVisualisationState *visualisationState; // output data stored in this variable
		public:
			enum GetImageType
			{
			...
			/// Process scene segmentation with localVAB
			void sceneSeg(ITMScene<ITMVoxel,ITMVoxelBlockHash> *scene);
			...
			void SaveAll();// seems still no implementation
